...
void checkOrderMemoryAlignment() {
    printf(
        "\nOrder alignof  p:%zu n:%zu tid:%zu  oid:%zu  cid:%zu  q:%zu  e:%zu  mst:%zu  lp:%zu  s:%zu",
    ...
    printf(
        "\nOrder sizeof   p:%lu n:%lu tid:%zu  oid:%lu  cid:%lu  q:%lu  e:%lu  mst:%lu  lp:%lu  s:%lu  size:%lu",
        sizeof(Orders::Order*),
        sizeof(Orders::Order*),
        sizeof(TickerIdT),
        sizeof(OrderIdT),
